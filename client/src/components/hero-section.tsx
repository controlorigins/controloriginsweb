      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
            <span className="text-accent">Microsoft Azure</span> &{" "}
            <span className="text-accent">ASP.NET</span> Portfolio Showcase
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 mb-6 leading-relaxed">
            A professional portfolio showcasing past business technology solutions,
            regulatory compliance expertise, and enterprise transformation projects.
